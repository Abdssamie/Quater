...
namespace Quater.Backend.Data.Migrations
{
    ...
    [Migration("20260127002333_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Quater.Backend.Core.Models.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Quater.Backend.Core.Models.AuditLogArchive", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Quater.Backend.Core.Models.Lab", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Quater.Backend.Core.Models.Parameter", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Quater.Backend.Core.Models.Sample", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Quater.Backend.Core.Models.SyncLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Quater.Backend.Core.Models.TestResult", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Quater.Backend.Core.Models.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Quater.Backend.Core.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Quater.Backend.Core.Models.AuditLog", b =>
                {
                    b.HasOne("Quater.Backend.Core.Models.User", "User")
                        .WithMany("AuditLogs")
                        .HasForeignKey("UserId")
            ...
            modelBuilder.Entity("Quater.Backend.Core.Models.Sample", b =>
                {
                    b.HasOne("Quater.Backend.Core.Models.Lab", "Lab")
                        .WithMany("Samples")
                        .HasForeignKey("LabId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Quater.Backend.Core.Models.TestResult", b =>
                {
                    b.HasOne("Quater.Backend.Core.Models.Sample", "Sample")
