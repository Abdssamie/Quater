...
public interface ISampleService
{
    ...
    Task<SampleDto> CreateAsync(CreateSampleDto dto, string userId, CancellationToken ct = default);
    Task<SampleDto?> UpdateAsync(Guid id, UpdateSampleDto dto, string userId, CancellationToken ct = default);
