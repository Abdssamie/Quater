...
public interface ITestResultService
{
    ...
    Task<TestResultDto> CreateAsync(CreateTestResultDto dto, string userId, CancellationToken ct = default);
    Task<TestResultDto?> UpdateAsync(Guid id, UpdateTestResultDto dto, string userId, CancellationToken ct = default);
