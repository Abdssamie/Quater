...
public interface ILabService
{
    ...
    Task<LabDto> CreateAsync(CreateLabDto dto, string userId, CancellationToken ct = default);
    Task<LabDto?> UpdateAsync(Guid id, UpdateLabDto dto, string userId, CancellationToken ct = default);
