...
namespace Quater.Desktop.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "AuditLogDtoPagedResult")]
    public partial class AuditLogDtoPagedResult : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AuditLogDtoPagedResult" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        /// <param name="totalCount">totalCount.</param>
        /// <param name="pageNumber">pageNumber.</param>
        /// <param name="pageSize">pageSize.</param>
        public AuditLogDtoPagedResult(List<AuditLogDto> items = default, int totalCount = default, int pageNumber = default, int pageSize = default)
        {
            this.Items = items;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AuditLogDtoPagedResult {\n");
