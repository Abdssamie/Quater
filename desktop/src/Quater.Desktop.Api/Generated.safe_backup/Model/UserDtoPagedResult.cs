...
namespace Quater.Desktop.Api.Model
{
    ...
    /// UserDtoPagedResult
    /// </summary>
    [DataContract(Name = "UserDtoPagedResult")]
    public partial class UserDtoPagedResult : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserDtoPagedResult" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        /// <param name="totalCount">totalCount.</param>
        /// <param name="pageNumber">pageNumber.</param>
        /// <param name="pageSize">pageSize.</param>
        public UserDtoPagedResult(List<UserDto> items = default, int totalCount = default, int pageNumber = default, int pageSize = default)
        {
            this.Items = items;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserDtoPagedResult {\n");
